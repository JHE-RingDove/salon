...
class MastersAdapter(private val names: List<Master>) : RecyclerView
.Adapter<MastersAdapter.ViewHolder>() {
...
//            CreateAppointment.RATING = names[position].rating
            ...
            val intent = Intent(viewHolder.constraintLayout.context, Comments::class.java)
//            intent.putExtra(CreateAppointment.SERVICE, "names[position]")
//            intent.putExtra(Comments.master, names[position].name)
